...
export default function DoctorsDashboard() {
  ...
  const fetchPatients = async () => {
    ...
    try {
      ...
      const patientsWithDetails = res.data.map(patient => ({
        ...
        visitingTime: new Date(patient.registration_time).toLocaleString('en-US', {
          hour: '2-digit',
          minute: '2-digit',
          hour12: true,
          day: '2-digit',
  ...
  return (
    <Flex direction="column" h="100vh" bg="gray.50" overflow="hidden">
      ...
      {/* MAIN */}
      <Box as="main" flex="1" px="2" py="6" mx="8" maxW="1200px" overflow="hidden">
        {/* Top cards */}
              ...
              {displayedPatients.length === 0 ? (
                ...
                displayedPatients.map((p, i) => (
                  ...
                  >
                    ...
                    <Box w="10%" minW="40px">
                      <Text fontSize="sm" color="gray.600">{p.age}</Text>
                    </Box>
                    <Box w="10%" minW="40px">
                      <Text fontSize="sm" color="gray.600">{p.gender}</Text>
                    </Box>
                    <Box w="22%" minW="140px">
                      <Text fontSize="sm" color="gray.600">{p.visitingTime}</Text>
                    </Box>
                    <Box w="20%" minW="120px">
                      <Text fontSize="sm" color="gray.600">{p.lastVisit || 'Nil'}</Text>
                    </Box>
                  </Flex>
                ))
              )}
