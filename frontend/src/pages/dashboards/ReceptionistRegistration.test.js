...
describe('ReceptionistRegistration Component', () => {
  ...
  it('renders correctly and fetches doctors', async () => {
    ...
    expect(screen.getAllByRole('heading', { name: /Register Patient/i }).length).toBeGreaterThan(0);
  ...
  it('navigates to schedule', () => {
    renderRegistration();
    const scheduleBtn = screen.getByText('Visiting Doctor Schedule', { selector: 'button' });
